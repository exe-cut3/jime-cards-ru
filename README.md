...
app/src/
  ...
  components/        # Filters, CardTile, CardModal, CardText, Badges, Icons
...
- [~] Этап 3 — приложение: прототип готов (поиск, фильтры, сетка, модалка, закладки, URL,
      русские сканы, Docker); нет планировщика колоды
